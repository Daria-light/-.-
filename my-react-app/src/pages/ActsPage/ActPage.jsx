...
function ActPage() {
   ...
   const loadObjects = async () => {
      ...
      try {
         const response = await objectsAPI.find(
            {},
            ['id', 'name', 'district_id', 'total_area'],
            100,
            0,
            'name',
            false,
         ...
         const mappedObjects = (response.data.items || []).map((obj) => ({
            id: obj.id,
            name: obj.name || 'Без названия',
            district: obj.district_id || 'Не указан',
            acts: 0,
         }))
      ...
      <div className={styles['acts-panel']}>
         <section className={styles['acts-hero']}>
            ...
            <p className={styles['muted-note']}>
               Обновление списка актов, массовое формирование документов и
               связывание PDF-файлов.
            </p>
         ...
         <section className={styles['acts-grid']}>
            <div className={styles['acts-box']}>
               ...
               <div className={styles['acts-actions']}>
                  <button className={['main-btn']} onClick={loadObjects}>
