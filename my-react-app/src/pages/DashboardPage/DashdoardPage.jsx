      ...
      try {
         ...
         const [roadmap2026, roadmap2027] = await Promise.all([
            Promise.all([
               ...
               const readyPercent =
                  total > 0
                     ? Math.round(((total - needAction) / total) * 100)
                     : 0
            ...
            <section className={styles['home-hero']}>
               <div>
                  ...
                  <p className={styles['home-overline-p']}>
                     Оперативная сводка по объектам УДС, статусам работ,
                     загрузке актов, карточкам по титулу и текущим задачам. Все
                     ключевые показатели и рабочие разделы собраны на одном
                     экране в единой визуальной стилистике.
                  </p>
                  ...
                  <div className={styles['home-hero-actions']}>
                     ...
                     <NavLink
                        to="/work-status"
                        className={styles['home-ghost-btn']}
                     >
               ...
               <div className={styles['home-hero-side']}>
                  ...
                  <div className={styles['home-side-panel']}>
                     ...
                     <p className={styles['home-side-panel-p']}>
                        Сводка формируется автоматически на основе данных
                        платформы и помогает быстро перейти к нужному рабочему
                        разделу.
                     </p>

                     <div className={styles['home-side-badges']}>
                        <span className={styles['home-side-badge']}>
                           АИС ЦД
                        </span>
               ...
               >
                  <div className={styles['home-card-head']}>
                     <div>
                        ...
                        <p className={styles['home-card-sub']}>
                           Быстрые переходы к основным модулям платформы для
                           ежедневной работы сотрудников.
                        </p>
                     </div>
                  </div>
                  ...
                  <div className={styles['home-module-grid']}>
                     ...
                     >
                        ...
                        <p>
                           Создание и актуализация карточек, шаблоны заполнения
                           и обоснования.
                        </p>
                        <div className={styles['home-module-meta']}>
                           <span className={styles['home-module-badge']}>
                     ...
                     <NavLink to="/tasks" className={styles['home-module']}>
                        ...
                        <p>
                           Контроль поручений, дедлайнов и ответственных
                           сотрудников.
                        </p>
                        <div className={styles['home-module-meta']}>
                           <span className={styles['home-module-badge']}>
                     ...
                     <NavLink to="/users" className={styles['home-module']}>
                        ...
                        <p>
                           Роли, доступы, должности и отделы сотрудников
                           платформы.
                        </p>
                        <div className={styles['home-module-meta']}>
                           <span
                  ...
                  >
                     <div className={styles['home-card-head']}>
                        <div>
                           ...
                           <p className={styles['home-card-sub']}>
                              Список активных задач и ближайших дедлайнов в
                              компактном формате.
                           </p>
                        </div>
                        ...
                        {loading ? (
                           ...
                           tasks.map((task) => (
                              ...
                              >
                                 ...
                                 <div className={styles.homeTaskTitle}>
                                    {task.name}
                                 </div>
                              </div>
                           ))
