...
const response = await dashboardApi.find()

setDashboardStats({
    geometry: response.data.geometryPercent,
    acts: response.data.actsPercent,
    uploads: response.data.uploadPercent,
})
*/
...
const response = await findAssignedTasks({
    columns: [],
    filter: {},
    limit: 3,
    offset: 0
